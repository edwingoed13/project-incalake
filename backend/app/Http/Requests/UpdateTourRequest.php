...
class UpdateTourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'departure_times.*.days' => 'nullable|integer|min:0|max:30',
            'departure_times.*.hours' => 'nullable|integer|min:0|max:23',
            'departure_times.*.minutes' => 'nullable|integer|min:0|max:59',
            'departure_period' => 'nullable|in:AM,PM',
            'duration_quantity' => 'nullable|numeric|min:0',
            'duration_unit' => 'nullable|in:days,hours,minutes',
            'duration_days' => 'nullable|integer|min:0|max:30',
            ...
            'translations.*.custom_sections' => 'nullable|array',
            'translations.*.custom_sections.*.title' => 'nullable|string|max:255',
            'translations.*.custom_sections.*.content' => 'nullable|string',
