<template>
  <div class="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" @click.self="$emit('close')">
    <div class="bg-default rounded-2xl shadow-2xl max-w-2xl w-full">
      <!-- Header -->
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              class="w-full px-4 py-2.5 bg-elevated border border-default rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none text-highlighted font-mono text-sm"
              placeholder="tours-en-puno"
            />
            <p class="text-xs text-muted mt-1">URL amigable (solo letras minúsculas, números y guiones)</p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-4 py-2.5 bg-elevated border border-default rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none text-highlighted resize-none"
          ...
          <div class="flex items-center gap-3">
            ...
            />
            <label for="active" class="text-sm font-medium text-default cursor-pointer">
              Categoría activa
            </label>
          </div>
