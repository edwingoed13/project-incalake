  ...
  <Teleport to="body">
    ...
    >
      <div v-if="open" class="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
        ...
        <div class="relative bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-3xl shadow-2xl">
          <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <h3 class="text-base font-bold text-slate-800">Compartir tour</h3>
            <button
              @click="$emit('close')"
              class="p-1.5 -mr-1.5 text-slate-400 hover:text-slate-700 active:scale-95 transition"
              aria-label="Cerrar"
            >
          ...
          <div class="p-5 space-y-4">
            <p v-if="title" class="text-sm font-semibold text-slate-700 line-clamp-2">{{ title }}</p>
            ...
            <div class="grid grid-cols-4 gap-3">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="flex flex-col items-center gap-1.5 p-2 rounded-xl hover:bg-slate-50 active:scale-95 transition"
              >
                ...
                <span class="text-[10px] font-semibold text-slate-600">WhatsApp</span>
              </a>
              ...
              >
                ...
                <span class="text-[10px] font-semibold text-slate-600">Facebook</span>
              </a>
              ...
              >
                ...
                <span class="text-[10px] font-semibold text-slate-600">X</span>
              </a>
              ...
              >
                ...
                <span class="text-[10px] font-semibold text-slate-600">Email</span>
              </a>
            </div>

            <!-- Copy link -->
            <div class="flex items-stretch gap-2 border border-slate-200 rounded-xl overflow-hidden">
              <input
                :value="url"
                readonly
                class="flex-1 min-w-0 px-3 py-2.5 text-xs text-slate-700 bg-transparent focus:outline-none truncate"
