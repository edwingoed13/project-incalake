      ...
      <div class="border border-slate-200 rounded-xl overflow-hidden">
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-primary-light">{{ t('included') }}</span>
          </div>
          <ChevronDownIcon
        ...
        <div
          ...
          class="p-4 bg-white"
        >
          <ul class="space-y-2 text-secondary-light">
      ...
      <div class="border border-slate-200 rounded-xl overflow-hidden">
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-primary-light">{{ t('not_included') }}</span>
          </div>
          <ChevronDownIcon
            class="size-5 text-slate-400 transition-transform"
